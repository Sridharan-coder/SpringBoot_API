...
import com.e_commerce.Entry.controller.UserController;
import com.e_commerce.Entry.dao.UserDAO;
import com.e_commerce.Entry.dto.UserDetails;
import com.e_commerce.Entry.repository.UserRepository;
...
public class UserDAOImple implements UserDAO {
	...
	public ResponseEntity<?> addUser(UserDetails userDetails) {
		...
		try {
			...
			String u_password=userDetails.getU_password();
	...
	public ResponseEntity<?> updateUser(Integer u_id,UserDetails UpdatedUserDetails) {
		...
		try {
			...
			update.set("u_password", UpdatedUserDetails.getU_password());
	...
	public ResponseEntity<?> userLogin(UserDetails user) {
		Map<String, Object> map = new LinkedHashMap<>();
		try {
			Optional<UserDetails> userTemp = userRepository.findByS_EmailAddress(user.getU_emailAddress());
